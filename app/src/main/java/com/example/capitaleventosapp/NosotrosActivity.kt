...
class NosotrosActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Menu3.setOnClickListener {
            val intent = Intent(this@NosotrosActivity, NosotrosActivity::class.java)
    ...
    override fun onClick(v: View?) {
        when(v?.id) {
            R.id.cvMenu1 -> {
                val intent = Intent(this@NosotrosActivity, MainActivity::class.java)
                startActivity(intent)
            }
            R.id.cvMenu2 -> {
                val intent = Intent(this@NosotrosActivity, ServiciosActivity::class.java)
                startActivity(intent)
            }
            R.id.cvMenu4 -> {
                val intent = Intent(this@NosotrosActivity, ContactoActivity::class.java)
                startActivity(intent)
            }
        }
    }
